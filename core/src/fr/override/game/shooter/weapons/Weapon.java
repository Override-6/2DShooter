...
import fr.override.game.shooter.animations.Animable;
...
import fr.override.game.shooter.util.GameConstants;
import fr.override.game.shooter.util.MathUtils;
...
public class Weapon implements GameSessionObject, Animable {
    ...
    public void update(float dt) {
        ...
        rotation = MathUtils.angle(getCenter(), new Vector2(mouseX, mouseY), GameConstants.VIEWPORT_HEIGHT - 13);
        muzzle.update(dt);
    }
