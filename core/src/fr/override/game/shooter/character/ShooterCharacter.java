...
import fr.override.game.shooter.util.ProgressBar;
...
public class ShooterCharacter extends RectangleComponent implements Character, Collidable {
    ...
    private final CharacterAbilities abilities;
    ...
    public void update(float deltaTime) {
        ...
        abilities.updateAbilities(deltaTime);
        isOnGround = false;
    }
    ...
    public void kill() {
        getCurrentGameSession().ifPresent(session -> {
            ...
            session.removeObject(this).then(() -> {
